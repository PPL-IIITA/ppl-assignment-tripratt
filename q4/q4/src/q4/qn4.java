...
public class qn4 {
	...
	public void gen_couple() throws IOException {
		...
		in = new FileReader("C:\\Users\\dell\\Desktop\\q4\\log_g.txt");
		in1 = new FileReader("C:\\Users\\dell\\Desktop\\q4\\log_b.txt");
		...
		String line;
		int m = 0;
		BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\dell\\Desktop\\q4\\log_g.txt"));
		BufferedReader br1 = new BufferedReader(new FileReader("C:\\Users\\dell\\Desktop\\q4\\log_b.txt"));
		...
		int line1;
		int x = 0, y = 0;
		BufferedReader gr = new BufferedReader(new FileReader("C:\\Users\\dell\\Desktop\\q4\\nameGirl.txt"));
		BufferedReader gr1 = new BufferedReader(new FileReader("C:\\Users\\dell\\Desktop\\q4\\nameBoy.txt"));
		...
		System.out.println("The " + ki + " least happiest couples are");
		for (int v = 0; v < ki; v++) {
			int j = 0;
