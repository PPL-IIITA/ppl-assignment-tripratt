...
public class couple {
	...
	public void gifting(boy[] brr, girl[] grr, int[] n, int f, char[] type_g, char[] type_b) throws IOException {
		...
		out1 = new FileWriter("C:\\Users\\dell\\Desktop\\q10\\luxuryGifts.txt");
		out = new FileWriter("C:\\Users\\dell\\Desktop\\q10\\essentialGifts.txt");
		out2 = new FileWriter("C:\\Users\\dell\\Desktop\\q10\\utilityGifts.txt");
		out3 = new FileWriter("C:\\Users\\dell\\Desktop\\q10\\couple.txt");
		...
		fn<essentialGift> ob = new fn<essentialGift>();
		ob.fnc(e, 50, price1);
		fn<utilityGift> ob1 = new fn<utilityGift>();
		ob1.fnc(u, 50, price2);
		fn<luxuryGift> ob2 = new fn<luxuryGift>();
		ob2.fnc(l, 50, price3);
