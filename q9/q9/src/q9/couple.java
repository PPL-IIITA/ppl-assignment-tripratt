...
public class couple {
	...
	public void gifting(boy[] brr, girl[] grr, int[] n, int f, char[] type_g, char[] type_b) throws IOException {
		...
		out1 = new FileWriter("C:\\Users\\dell\\Desktop\\q9\\luxuryGifts.txt");
		out = new FileWriter("C:\\Users\\dell\\Desktop\\q9\\essentialGifts.txt");
		out2 = new FileWriter("C:\\Users\\dell\\Desktop\\q9\\utilityGifts.txt");
		out3 = new FileWriter("C:\\Users\\dell\\Desktop\\q9\\couple.txt");
