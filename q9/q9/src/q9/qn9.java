...
public class qn9 {
	...
	public void fnc() throws FileNotFoundException, IOException {
		...
		in = new FileReader("C:\\Users\\dell\\Desktop\\q9\\log_g.txt");
		in1 = new FileReader("C:\\Users\\dell\\Desktop\\q9\\log_b.txt");
		...
		for (int i = 0; i < 12; i++) {
			if (cateG[i] == 'c') {
				...
				BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\dell\\Desktop\\q9\\log_g.txt"));
				line = br.readLine();
		...
		BufferedReader br1 = new BufferedReader(new FileReader("C:\\Users\\dell\\Desktop\\q9\\log_b.txt"));
		for (int i = 0; i < 58; i++) {
			if (cateB[i] == 'm') {
				b[i] = new miserBoy();
		...
		int line1;
		int x = 0, y = 0;
		BufferedReader gr = new BufferedReader(new FileReader("C:\\Users\\dell\\Desktop\\q9\\nameGirl.txt"));
		BufferedReader gr1 = new BufferedReader(new FileReader("C:\\Users\\dell\\Desktop\\q9\\nameBoy.txt"));
		...
		System.out.println("The " + 4 + " most happies couples are");
