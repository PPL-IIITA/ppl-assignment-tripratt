...
public class couple {
	...
	public void gifting(boy[] brr, girl[] grr, int[] n, int f) throws IOException {
		...
		out1 = new FileWriter("C:\\Users\\dell\\Desktop\\q7\\luxuryGifts.txt");
		out = new FileWriter("C:\\Users\\dell\\Desktop\\q7\\essenentialGifts.txt");
		out2 = new FileWriter("C:\\Users\\dell\\Desktop\\q7\\utilityGifts.txt");
		out3 = new FileWriter("C:\\Users\\dell\\Desktop\\q7\\couple.txt");
